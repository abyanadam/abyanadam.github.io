...
<head>
    ...
    <title>Abyan Adam - Portfolio</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="description" content="Portfolio Website" />
    <meta name="keywords" content="website, portfolio, html" />
...
<body>
        ...
        <div class="page-content">
            ...
            <header id="site_header" class="header mobile-menu-hide">
                ...
                <div class="social-links">
                    <ul>
                        <li>
                            <a href="https://www.linkedin.com/in/abyan-adam/" target="_blank">
                                <i class="fab fa-linkedin-in"></i>
                            </a></li>
                        <li>
                            <a href="https://web.facebook.com/AbyanAdam/" target="_blank">
                                <i class="fab fa-facebook-f"></i>
                            </a></li>
                        <li>
                            <a href="https://twitter.com/abyan_adam2nd" target="_blank">
                                <i class="fab fa-twitter"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://github.com/abyanadam" target="_blank">
                                <i class="fab fa-github"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/abyan_adam/" target="_blank">
                                <i class="fab fa-instagram"></i>
                            </a></li>
                        <li>
                            <a href="https://bit.ly/38OuHWd" target="_blank">
                        ...
                        <div class="section-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-7">
                                    <p>Proin volutpat mauris ac pellentesque pharetra. Suspendisse congue elit vel odio suscipit, sit amet tempor nisl imperdiet. Quisque ex justo, faucibus ut mi in, condimentum finibus dolor. Aliquam vitae hendrerit dolor,
                                        eget imperdiet mauris. Maecenas et ante id ipsum condimentum dictum et vel massa. Ut in imperdiet dolor, vel consectetur dui.</p>
                                </div>
                                    ...
                                    <div class="info-list">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span class="value">Padang, West Sumatera</span>
                                            </li>

                                            <li>
                                                <span class="title">e-mail</span>
                                                <span class="value">abyanadam10@gmail.com</a></span>
                                            </li>

                                            <li>
                                                <span class="title">Phone</span>
                                                <span class="value">+62 822 8482 8941</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="timeline timeline-second-style clearfix">
                                        <div class="timeline-item clearfix">
                                            <div class="left-part">
                                                ...
                                                <span class="item-company">Universitas Putra Indonesia YPTK</span>
                                            </div>
                                        ...
                                        <div class="timeline-item clearfix">
                                            <div class="left-part">
                                                ...
                                                <span class="item-company">SMK N 2 Padang</span>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="right-part">
                                                <h4 class="item-title">Teknik Komputer Jaringan</h4>
                                                <!-- <p>
                                    ...
                                    <div class="timeline timeline-second-style clearfix">
                                        <div class="timeline-item clearfix">
                                            <div class="left-part">
                                                ...
                                                <span class="item-company">Sukumaya</span>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="right-part">
                                                <h4 class="item-title">Web Developer</h4>
                                                <p>
                                                    Creating and maintaining a website, starting from system analysis, database design, determining the website interface (front end), data management (back end) until a website is ready to be published.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item clearfix">
                                            <div class="left-part">
                                                <h5 class="item-period">2020 - Curent</h5>
                                                <span class="item-company">Line Up</span>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="right-part">
                                                <h4 class="item-title">Web Developer</h4>
                                        ...
                                        <div class="timeline-item clearfix">
                                            <div class="left-part">
                                                <h5 class="item-period">2020 - Curent</h5>
                                                <span class="item-company">PT. Yosa Pertama Solusindo</span>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="right-part">
                                                <h4 class="item-title">Web Developer</h4>
                                                <p>
                                                    Creating and maintaining a website, starting from system analysis, database design, data management until a website is ready to be published.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="timeline-item clearfix">
                                            <div class="left-part">
                                                ...
                                                <span class="item-company">CV. Mediatama Web Indonesia</span>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="right-part">
                                                <h4 class="item-title">Web Developer</h4>
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    ...
                                    <div class="skills-info skills-second-style">
                                        ...
                                        <div class="skill clearfix">
                                            <h4>PHP (Laravel, Codeigniter, Native)</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    ...
                                    <div class="lm-info-block gray-default">
                                        ...
                                        <h4><a href="https://lmpixels.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a4c5c8c1dce4c1dcc5c9d4c8c18ac7cbc9">[email&#160;protected]</a></h4>
                                        <span class="lm-info-block-value"></span>
                                        <span class="lm-info-block-text"></span>
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    ...
                                    <form id="contact_form" class="contact-form" action="https://lmpixels.com/demo/breezycv/light/3/contact_form/contact_form.php" method="post">
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194" integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw==" data-cf-beacon='{"rayId":"6faa64b50aac4c03","version":"2021.12.0","r":1,"token":"94b99c0576dc45bf9d669fb5e9256829","si":100}' crossorigin="anonymous"></script>
</body>
